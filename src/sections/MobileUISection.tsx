...
export function MobileUISection({ t, isDark, g }: SectionProps) {
  return (
    <Section
      ...
      t={t}
    >
      <div className="flex gap-8 overflow-x-auto py-2 pb-6">
        {/* Library */}
        <PhoneFrame t={t} bg={t.bg}>
          <div className="flex h-full flex-col">
            <div className="flex-1 px-4 pt-6">
              <div
                className="mb-0.5 text-[22px] font-heading font-semibold"
                style={{ color: t.fg }}
              >
                Library
              </div>
        ...
        <PhoneFrame t={t} bg={t.bg}>
          <div className="px-4 pt-6">
            ...
            >
              <div
                className="mb-0.5 text-[17px] font-heading font-semibold"
                style={{ color: t.fg }}
              >
                Design
              </div>
            ...
            <div
              className="mb-3 flex w-fit gap-0.5 rounded-lg p-0.5"
              style={{ background: t.inputBg }}
            >
              {["Grid", "List"].map((m, i) => (
                <span
              ...
              <div className="rounded-xl p-3" style={{ background: t.surface }}>
                ...
                <div className="flex gap-2">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-14 w-11 rounded-md"
                      style={{ background: t.inputBg }}
                    />
                  ))}
                </div>
